...
public class LevelSelectorState extends State{
	...
	private  int xOffset = (Window.WIDTH - DOUBLETILESIZE*6)/2;
	private  int yOffset = (Window.HEIGHT - DOUBLETILESIZE*5)/2;
	...
	public LevelSelectorState(Window window) {
		...
		back = new Button("BACK",width/2, height - 50, new Click(){
	...
	public void render(Graphics g){
		back.render(g, Window.WIDTH / 2, Window.HEIGHT - 50);
		
		xOffset = (Window.WIDTH - DOUBLETILESIZE*6)/2;
		yOffset = (Window.HEIGHT - DOUBLETILESIZE*5)/2;
